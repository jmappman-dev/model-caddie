...
2. **Misroutes are bugs, and the fix is a test case.** If the router sends a task to the wrong lane, open an issue with the exact task text, the output of `node bin/model-router.js --json "<task>"`, and what you expected.
